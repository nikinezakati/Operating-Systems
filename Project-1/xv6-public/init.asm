   ...
   1:	b9 02 00 00 00       	mov    $0x2,%ecx
{
  ...
  13:	c7 04 24 68 08 00 00 	movl   $0x868,(%esp)
  1a:	e8 a4 03 00 00       	call   3c3 <open>
  ...
  2e:	e8 c8 03 00 00       	call   3fb <dup>
  dup(0);  // stderr
  33:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  3a:	e8 bc 03 00 00       	call   3fb <dup>
  3f:	90                   	nop

  for(;;){
    printf(1, "init: starting sh\n");
  40:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  47:	ba 70 08 00 00       	mov    $0x870,%edx
  4c:	89 54 24 04          	mov    %edx,0x4(%esp)
  50:	e8 ab 04 00 00       	call   500 <printf>
    pid = fork();
  55:	e8 21 03 00 00       	call   37b <fork>
    if(pid < 0){
  ...
  70:	e8 16 03 00 00       	call   38b <wait>
  ...
  8b:	b8 af 08 00 00       	mov    $0x8af,%eax
  90:	89 44 24 04          	mov    %eax,0x4(%esp)
  94:	e8 67 04 00 00       	call   500 <printf>
  99:	eb d5                	jmp    70 <main+0x70>
      printf(1, "init: fork failed\n");
  9b:	c7 44 24 04 83 08 00 	movl   $0x883,0x4(%esp)
  a2:	00 
  a3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  aa:	e8 51 04 00 00       	call   500 <printf>
      exit();
  af:	e8 cf 02 00 00       	call   383 <exit>
      exec("sh", argv);
  b4:	c7 44 24 04 54 0b 00 	movl   $0xb54,0x4(%esp)
  bb:	00 
  bc:	c7 04 24 96 08 00 00 	movl   $0x896,(%esp)
  c3:	e8 f3 02 00 00       	call   3bb <exec>
      printf(1, "init: exec sh failed\n");
  c8:	c7 44 24 04 99 08 00 	movl   $0x899,0x4(%esp)
  cf:	00 
  d0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  d7:	e8 24 04 00 00       	call   500 <printf>
      exit();
  dc:	e8 a2 02 00 00       	call   383 <exit>
    mknod("console", 1, 1);
  e1:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
  e8:	00 
  e9:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
  f0:	00 
  f1:	c7 04 24 68 08 00 00 	movl   $0x868,(%esp)
  f8:	e8 ce 02 00 00       	call   3cb <mknod>
    open("console", O_RDWR);
  fd:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
 104:	00 
 105:	c7 04 24 68 08 00 00 	movl   $0x868,(%esp)
 10c:	e8 b2 02 00 00       	call   3c3 <open>
 ...
 437:	89 d1                	mov    %edx,%ecx
{
 ...
 485:	89 45 c4             	mov    %eax,-0x3c(%ebp)
    buf[i++] = digits[x % base];
 488:	0f b6 92 c0 08 00 00 	movzbl 0x8c0(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 690:	89 75 d4             	mov    %esi,-0x2c(%ebp)
          s = "(null)";
 693:	bb b8 08 00 00       	mov    $0x8b8,%ebx
        while(*s != 0){
 ...
 706:	73 10                	jae    718 <free+0x38>
{
 ...
 757:	75 d6                	jne    72f <free+0x4f>
  freep = p;
 759:	a3 5c 0b 00 00       	mov    %eax,0xb5c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 81c:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 81f:	a3 5c 0b 00 00       	mov    %eax,0xb5c
      return (void*)(p + 1);
 ...
 82f:	90                   	nop
    base.s.ptr = freep = prevp = &base;
 830:	b8 60 0b 00 00       	mov    $0xb60,%eax
 835:	ba 60 0b 00 00       	mov    $0xb60,%edx
 83a:	a3 5c 0b 00 00       	mov    %eax,0xb5c
    base.s.size = 0;
 83f:	31 c9                	xor    %ecx,%ecx
 841:	bf 60 0b 00 00       	mov    $0xb60,%edi
    base.s.ptr = freep = prevp = &base;
 846:	89 15 60 0b 00 00    	mov    %edx,0xb60
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 84c:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 84e:	89 0d 64 0b 00 00    	mov    %ecx,0xb64
    if(p->s.size >= nunits){
