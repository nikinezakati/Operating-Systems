   ...
   a:	83 7d 08 03          	cmpl   $0x3,0x8(%ebp)
{
  ...
  13:	c7 44 24 04 b8 07 00 	movl   $0x7b8,0x4(%esp)
  1a:	00 
  ...
  51:	c7 44 24 04 cb 07 00 	movl   $0x7cb,0x4(%esp)
  58:	00 
 ...
 387:	89 d1                	mov    %edx,%ecx
{
 ...
 3d5:	89 45 c4             	mov    %eax,-0x3c(%ebp)
    buf[i++] = digits[x % base];
 3d8:	0f b6 92 e8 07 00 00 	movzbl 0x7e8(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 5e0:	89 75 d4             	mov    %esi,-0x2c(%ebp)
          s = "(null)";
 5e3:	bb df 07 00 00       	mov    $0x7df,%ebx
        while(*s != 0){
 ...
 656:	73 10                	jae    668 <free+0x38>
{
 ...
 6a7:	75 d6                	jne    67f <free+0x4f>
  freep = p;
 6a9:	a3 7c 0a 00 00       	mov    %eax,0xa7c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6c9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6cc:	8b 3d 7c 0a 00 00    	mov    0xa7c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 719:	8b 3d 7c 0a 00 00    	mov    0xa7c,%edi
 ...
 76c:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 76f:	a3 7c 0a 00 00       	mov    %eax,0xa7c
      return (void*)(p + 1);
 ...
 77f:	90                   	nop
    base.s.ptr = freep = prevp = &base;
 780:	b8 80 0a 00 00       	mov    $0xa80,%eax
 785:	ba 80 0a 00 00       	mov    $0xa80,%edx
 78a:	a3 7c 0a 00 00       	mov    %eax,0xa7c
    base.s.size = 0;
 78f:	31 c9                	xor    %ecx,%ecx
 791:	bf 80 0a 00 00       	mov    $0xa80,%edi
    base.s.ptr = freep = prevp = &base;
 796:	89 15 80 0a 00 00    	mov    %edx,0xa80
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 79c:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 79e:	89 0d 84 0a 00 00    	mov    %ecx,0xa84
    if(p->s.size >= nunits){
