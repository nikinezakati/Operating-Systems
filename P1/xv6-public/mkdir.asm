...
main(int argc, char *argv[])
{
  ...
  25:	e8 11 03 00 00       	call   33b <mkdir>
  ...
  3d:	c7 44 24 04 cf 07 00 	movl   $0x7cf,0x4(%esp)
  44:	00 
 ...
 387:	89 d1                	mov    %edx,%ecx
{
 ...
 3d5:	89 45 c4             	mov    %eax,-0x3c(%ebp)
    buf[i++] = digits[x % base];
 3d8:	0f b6 92 f4 07 00 00 	movzbl 0x7f4(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 5e0:	89 75 d4             	mov    %esi,-0x2c(%ebp)
          s = "(null)";
 5e3:	bb eb 07 00 00       	mov    $0x7eb,%ebx
        while(*s != 0){
 ...
 656:	73 10                	jae    668 <free+0x38>
{
 ...
 681:	5b                   	pop    %ebx
  freep = p;
 682:	a3 8c 0a 00 00       	mov    %eax,0xa8c
}
 687:	5e                   	pop    %esi
 688:	5f                   	pop    %edi
 689:	5d                   	pop    %ebp
 ...
 6a7:	75 d6                	jne    67f <free+0x4f>
  freep = p;
 6a9:	a3 8c 0a 00 00       	mov    %eax,0xa8c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6c9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6cc:	8b 3d 8c 0a 00 00    	mov    0xa8c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 719:	8b 3d 8c 0a 00 00    	mov    0xa8c,%edi
 ...
 73e:	e8 ed fe ff ff       	call   630 <free>
  return freep;
 743:	a1 8c 0a 00 00       	mov    0xa8c,%eax
 ...
 76c:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 76f:	a3 8c 0a 00 00       	mov    %eax,0xa8c
      return (void*)(p + 1);
 ...
 77f:	90                   	nop
    base.s.ptr = freep = prevp = &base;
 780:	b8 90 0a 00 00       	mov    $0xa90,%eax
 785:	ba 90 0a 00 00       	mov    $0xa90,%edx
 78a:	a3 8c 0a 00 00       	mov    %eax,0xa8c
    base.s.size = 0;
 78f:	31 c9                	xor    %ecx,%ecx
 791:	bf 90 0a 00 00       	mov    $0xa90,%edi
    base.s.ptr = freep = prevp = &base;
 796:	89 15 90 0a 00 00    	mov    %edx,0xa90
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 79c:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 79e:	89 0d 94 0a 00 00    	mov    %ecx,0xa94
    if(p->s.size >= nunits){
